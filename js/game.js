...
const LEVELS = [
  {
    ...
    timeLimit: 120,
    diffs: [
      { id:0, x:255, y:50,  r:38, hint:'벽에 걸린 시계 색이 다릅니다' },
      { id:1, x:87,  y:103, r:50, hint:'창문 커튼 색을 확인해 보세요' },
      { id:2, x:385, y:87,  r:55, hint:'TV 테두리 색이 다릅니다' },
      { id:3, x:471, y:36,  r:22, hint:'책장의 책 개수를 세어 보세요' },
      { id:4, x:410, y:293, r:38, hint:'화분의 색이 다릅니다' },
    ],
  },
  {
    name: '해변',
    ...
    diffs: [
      ...
      { id:2, x:385, y:285, r:35, hint:'비치볼 색과 무늬가 다릅니다' },
      { id:3, x:275, y:78,  r:32, hint:'하늘의 새 수가 다릅니다' },
      { id:4, x:172, y:210, r:50, hint:'파라솔 색이 다릅니다' },
      { id:5, x:300, y:342, r:65, hint:'파도 색이 다릅니다' },
    ],
  },
  {
    name: '우주',
    ...
    diffs: [
      ...
      { id:1, x:128, y:275, r:34, hint:'로켓 불꽃 색을 확인하세요' },
      { id:2, x:220, y:135, r:45, hint:'별의 개수가 다릅니다' },
      { id:3, x:68,  y:55,  r:44, hint:'달의 모양이 다릅니다' },
      { id:4, x:295, y:215, r:30, hint:'우주인 헬멧 바이저 색이 다릅니다' },
      { id:5, x:415, y:110, r:62, hint:'행성 주변을 자세히 살펴보세요' },
      { id:6, x:358, y:48,  r:32, hint:'유성의 크기를 비교해 보세요' },
    ],
  },
];
